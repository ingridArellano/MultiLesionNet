...
for file in $input_files; do
  ...
  #python3 -m CTLungSeg.labeling --input="$input_dir$file" --output="$label_dir$f.nii.gz" --centroids="$centroids"
  python3 -m scripts.filter --input="$input_dir$file" --output="$label_dir$f"
